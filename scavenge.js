...
<button class="button button2" id="delbutton">Reset</button>
</div>
<br>
</html>
...
if (localStorage.getItem("attempts") === null) {
    ...
    document.title = "You sent " + attempts + "/" + vil;
};
...
';
    ...
    var farm = parseInt(document.querySelector('#pop_current_label').textContent) > 1000
    var capacity = parseInt(document.querySelector('#scavenge_screen > div.scavenge-screen-main-widget > div.candidate-squad-container > table > tbody > tr:nth-child(2) > td.carry-max').innerText);
    ...
    if(farm && capacity > 0 && start3 && (blok4 || odb4 || unl4)){
    ...
    if(farm && capacity > 0 && start2 && ((blok3 || odb3) || unl3) && ((blok4 || odb4) || unl4)){
    ...
    if(farm && capacity > 0 && start1 && ((blok2 || odb2) || unl2) && ((blok3 || odb3) || unl3) && ((blok4 || odb4) || unl4)){
...
function odblokowanie(){
    ...
    if(!odb1 && !unl1 && !odb2 && !unl2 && odb3 && odb4){
