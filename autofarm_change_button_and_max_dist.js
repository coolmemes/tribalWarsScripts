...
let switchSpeed;
let speed; // Time between attacks in ms
...
$("#switchSpeedOk").click(function() {
    ...
    if(parseInt(switchSpeed) === 0) {
        ...
        document.getElementById("textSwitch").innerHTML = "Switch attackMs set to " + switchSpeed + " seconds";
    }
...
let farmA = {
    spear: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="spear"]').value),
    sword: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="sword"]').value),
    axe: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="axe"]').value),
    spy: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="spy"]').value),
    light: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="light"]').value),
    heavy: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="heavy"]').value)
};

let farmB = {
    spear: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="spear"]').value),
    sword: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="sword"]').value),
    axe: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="axe"]').value),
    spy: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="spy"]').value),
    light: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="light"]').value),
    heavy: parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="heavy"]').value)
};
...
try {
    farmA.archer = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="archer"]').value);
    farmA.marcher = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="marcher"]').value);
    farmB.archer = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="archer"]').value);
    farmB.marcher = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="marcher"]').value);
...
try {
    farmB.knight = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(2) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="knight"]').value);
    farmA.knight = parseInt(document.querySelector('#content_value > div:nth-child(4) > div > form:nth-child(1) > table > tbody > ' +
        'tr:nth-child(2) > td > input[name="knight"]').value);
