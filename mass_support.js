javascript: (function() {
	...
	function segunda() {
		let html = ['<th> Minha Aldeia </th>', '<th> Aldeia Alvo </th>', '<th> Dura%C3%A7%C3%A3o </th>', '<th id="enviar"> > Enviar < </th>'];
				...
				$.ajax({
					...
					success: function(data) {
						if (!data.error) {
							...
							let html = ['<td style="text-align:center">', minha.c, '</td>', '<td style="text-align:center">', minha.alvoDessa.c, '</td>', '<td style="text-align:center">', tempo, '</td>', '<td id="aindanao" style="text-align:center">AINDA N%C3%83O</td>'];
